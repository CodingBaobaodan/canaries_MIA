...
def conjugate_gradient(ax_fn, b, debug_callback=None, avextol=None, maxiter=None):
    ...
    """
    # when callback print, the Conjugate function value == linear + quadratic, 
    # where linear == - b^T x, quad == x^T A x / 2, x is the vector we try to 
    # minimise and will be return 
